...
export default function SessionCreate({ academicSessions = [], classSectionGroups = [] }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('attendance.sessions.store'), { preserveScroll: true });
    };
                    ...
                    <div className="mb-6">
                        ...
                        <div className="flex items-center gap-3 mt-2">
                            <div className="w-12 h-12 rounded-lg flex items-center justify-center bg-[#e8eef7]">
                                <FontAwesomeIcon icon={faCalendarPlus} className="text-amber-500 text-xl" />
                            </div>
                            <div>
                                <h1 className="text-2xl font-bold text-gray-900">New Attendance Session</h1>
                                <p className="text-sm text-gray-500 mt-0.5">Create a session for marking student, teacher or employee attendance.</p>
                            </div>
                        </div>
                    </div>
