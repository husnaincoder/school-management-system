...
import { faArrowLeft, faClipboardList, faSave, faUserGraduate } from '@fortawesome/free-solid-svg-icons';
...
export default function StudentEdit({ student, parents = [], classSectionGroups = [] }) {
    ...
    const initialGroupId = useMemo(
        () => (enrollment?.class_section_group_id ? String(enrollment.class_section_group_id) : ''),
        [enrollment?.class_section_group_id]
    );
    ...
    const form = useForm({
        ...
        sibling_discount_eligible: !!student?.sibling_discount_eligible,
        class_section_group_id: initialGroupId,
        enrollment_admission_date: enrollment?.admission_date
            ? enrollment.admission_date.split('T')[0]
    ...
    useEffect(() => {
        ...
        if (form.data.class_section_group_id === initialGroupId && initialNumber) {
            setStudentNumber(initialNumber);
            return;
        }
    ...
    }, [form.data.class_section_group_id, initialGroupId, initialNumber]);

    const submit = (e) => {
        e.preventDefault();
        const hasFile = form.data.profile_photo instanceof File;
        form.patch(route('academic.students.update', student.id), {
            preserveScroll: true,
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="mb-6 flex items-center justify-between gap-3">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-0.5">Update user account, student profile, and enrollment.</p>
                            </div>
                        </div>
                        <Link
                            ...
                            <div className="lg:col-span-7 bg-white rounded-xl border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.08)] p-6 h-full">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        {student?.profile_photo && !form.data.profile_photo && (
                                            <div className="mb-2">
                                                <img src={`/storage/${student.profile_photo}`} alt="Current" className="w-16 h-16 rounded-full object-cover border border-gray-200" />
                                        ...
                                        {form.data.profile_photo && <p className="text-green-600 text-xs mt-1">New file: {form.data.profile_photo.name}</p>}
                        ...
                        <div className="bg-white rounded-xl border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.08)] p-6">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">Update class section group and enrollment details.</p>
                                </div>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 mt-1">
                                        {form.data.class_section_group_id !== initialGroupId
                                            ? 'New number assigned when class section group changes.'
                                            : 'Auto: Class-Section-Group-01 format.'}
                                    </p>
                    ...
                    <ParentQuickCreateModal
                        ...
                        onCreated={(parent) => {
                            ...
                            form.setData('parent_id', String(parent.id));
                        }}
                    />
                </div>
            </div>
