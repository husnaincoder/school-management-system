                    ...
                    <div className="mb-6 flex items-center justify-between gap-3">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-0.5">Creates a new user account with role <strong>Parent</strong> and a parent profile.</p>
                            </div>
                        </div>
                        <Link
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
                            <div className="lg:col-span-5 bg-white rounded-xl border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.08)] p-6 h-full">
                                ...
                                <p className="text-sm text-gray-500 mb-4">Role will be automatically set to <span className="font-medium text-amber-600">Parent</span>.</p>
                                <div className="grid grid-cols-1 gap-4">
                                    ...
                                    <div className="rounded-lg bg-amber-50 border border-amber-200 p-3.5 text-sm text-amber-900">
                                        ...
                                        <p className="text-xs text-amber-700 mt-1">
                                            A secure, distinct login password for the Parent Portal will be automatically generated upon creation.
                                        </p>
                                    </div>
                                </div>
                            </div>
