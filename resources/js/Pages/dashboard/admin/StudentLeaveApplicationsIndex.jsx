...
import { faCalendarXmark, faFilter, faArrowLeft } from '@fortawesome/free-solid-svg-icons';
...
export default function StudentLeaveApplicationsIndex({ applications, classSectionGroups = [], filters = {} }) {
    ...
    const applyFilters = (e) => {
        e?.preventDefault();
        router.get(route('admin.student-leave-applications.index'), filterState, { preserveState: true });
    };

    const handleApprove = (app) => {
        if (confirm('Approve this leave application?')) {
            router.post(route('admin.student-leave-applications.approve', app.id));
        }
    };
    ...
    const handleReject = (app) => {
        ...
        if (remarks !== null) {
            router.post(route('admin.student-leave-applications.reject', app.id), { remarks });
        }
    };
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Student Leave Applications" />
            <div className="py-8">
                    ...
                    <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-0.5">Approve or reject leave applications submitted by parents for their children.</p>
                            </div>
                        </div>
                        <Link
                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody className="divide-y divide-gray-200 bg-white">
                                    {data.length === 0 ? (
                                        <tr>
                                            <td colSpan={7} className="px-6 py-12 text-center text-gray-500">No student leave applications found.</td>
                                        </tr>
                                    ) : (
                                        data.map((app) => (
