...
export default function MyLeaveEdit({ leave, leaveTypes = [] }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('employee.my-leaves.update', leave?.id));
    };
        ...
        <AuthenticatedLayout>
            ...
            <div className="py-8">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="mb-6">
                        <Link href={route('employee.my-leaves.show', leave?.id)} className="text-gray-500 hover:text-gray-700 text-sm font-medium">← Back to application</Link>
                        <div className="flex items-center gap-3 mt-2">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-0.5">Update your pending leave request.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.08)] p-6">
                        <form onSubmit={submit} className="space-y-5">
                            ...
                            <div className="flex flex-wrap gap-3 pt-2">
                                ...
                                <Link
                                    href={route('employee.my-leaves.show', leave?.id)}
